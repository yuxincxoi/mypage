...
export const projectStatics = {
  project_1: {
    ...
    function: [
      ...
      [
        "메인 페이지",
        `사용자가 원하는 짬뽕집을 검색하고 지도에 표시합니다.
짬뽕집을 나만의 리스트에 추가할 수 있습니다.`,
      ],
      [
        "좋아요 페이지",
        "나만의 리스트를 확인하고 지도를 통해 짬뽕집 정보를 얻습니다.",
      ],
      [
        "마이페이지",
...
이름 및 비밀번호를 변경할 수 있습니다.`,
  ...
  project_2: {
    ...
    function: [
      [
        "사용자 페이지",
        `잔액을 충전하고 원하는 제품을 선택해서 장바구니에 담아 꿈을 구매합니다.`,
      ],
  ...
  project_3: {
    ...
    function: [
      ...
      [
        "마이 페이지",
        "비밀번호를 변경하거나 주문했던 내역들을 확인할 수 있습니다.",
      ],
      [
        "관리자 페이지 - 재고 조회",
        "제품 발주를 넣고 제품 정보를 수정할 수 있습니다.",
      ],
      [
        "관리자 페이지 - 유통기한 관리",
  ...
  project_6: {
    ...
    exp: `머신러닝을 주제로 진행된 프로젝트입니다.
    머신러닝을 활용해 야생동물의 종을 식별하고, 출몰 위치를 제보합니다.
    ...
    * 머신러닝을 통한 동물 종 식별까지를 목표로 구현했습니다.
    ...
    function: [
      ...
      [
        "위치 제보 페이지",
        `출몰 지역의 키워드나 주소를 통해 검색하면 해당 장소에 마커가 표시됩니다.
        마커를 클릭하면 해당 장소를 중심으로한 위험 반경이 표시되고 제보하기 버튼이 활성화됩니다. 
        'Report' 버튼을 누르면 위험 반경 지역의 사용자들에게 알림이 전송됩니다.`,
      ],
  ...
  project_10: {
    ...
    exp: `일정을 확인하고 관리할 수 있는 스케쥴러입니다. 여행 관련 애플리케이션 제작에 활용될 예정입니다.`,
    img: imagePaths.project_10,
    function: [
      [
        "월별 캘린더",
        "이전, 다음 달로 이동할 수 있는 캘린더입니다. 캘린더에는 각 날짜에 추가되어 있는 일정이 표시됩니다.",
      ],
      [
        "세부 일정 확인",

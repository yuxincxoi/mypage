...
export const projectStatics = {
  project_1: {
    ...
    exp: `I LIKE 짬뽕은 전국의 짬뽕 맛집을 쉽게 찾고, 나만의 맛집 리스트를 관리할 수 있는 웹 애플리케이션입니다.
    사용자들은 지도를 활용하여 주변의 짬뽕집을 검색하고, 즐겨찾기 기능을 통해 자신만의 리스트를 만들어 관리할 수 있습니다.`,
  ...
  project_3: {
    ...
    exp: `크랩크랩 버거는 '만약 스폰지밥 속 집게리아가 실제로 존재한다면?'이라는 발상에서 시작된 햄버거 구매 및 재고 관리 ERP 시스템입니다.
  ...
  project_4: {
    ...
    exp: `AI 기반으로 실시간 야생동물 모니터링 및 출몰 알림을 제공하는 서비스입니다.
    머신러닝을 활용해 야생동물의 종을 식별하고, 위해동물로 분류될 경우 해당 위치를 제보할 수 있습니다.
    제보가 완료되면 해당 지역을 중심으로 위험 반경에 위치한 사용자들에게 출몰 알림을 전송합니다. 또한 실시간 데이터 분석을 통해 멸종위기종 및 야생동물 보호 연구에도 활용됩니다.
    야생동물의 출몰이 빈번한 지역 및 피해 농가, 연구자들에게 실질적인 도움을 주기 위한 서비스를 목표로 개발했습니다.`,
    img: ["사진1", "사진2", "사진3"],
    function: [
  ...
  project_7: {
    ...
    exp: `Cota는 코드 타자연습 게임으로, 주어진 코드를 빠르고 정확하게 입력하는 게임입니다.
  ...
  project_8: {
    ...
    type: "personal",
    stack: ["React", "TypeScript", "TailwindCSS"],
    exp: `Chord Clip은 사용자가 노래를 녹음하고, 그것을 기준으로 3도 위의 음을 생성하여 재생하는 웹 애플리케이션입니다.

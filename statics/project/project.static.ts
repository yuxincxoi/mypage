...
이름 및 비밀번호를 변경할 수 있습니다.`,
    ...
    character: [
      "카카오지도 API를 활용하여 위치 기반의 짬뽕 맛집 정보를 시각화했습니다.",
      "JWT 기반의 인증 시스템 구현을 통해 사용자의 인증 관리 및 보호된 페이지 접근 제어를 수행하여 보안을 강화했습니다.",
      "컴포넌트를 기능 단위로 설계하여 재사용성과 유지보수성을 높였습니다.",
      "CRUD 기능을 구현하여 사용자가 맛집 데이터를 조회 및 추가, 삭제하거나 개인 정보를 수정할 수 있도록 했습니다.",
  ...
  project_2: {
    ...
    character: [
      "CRUD 기능을 구현하여 장바구니 및 제품 데이터를 조회 및 추가, 수정, 삭제할 수 있도록 했습니다.",
  ...
  project_3: {
    ...
    character: [
      "JWT 기반의 인증 시스템 구현을 통해 사용자의 인증, 권한 관리 및 보호된 페이지 접근 제어를 수행하여 보안을 강화했습니다.",
      "컴포넌트를 기능 단위로 설계하여 재사용성과 유지보수성을 높였습니다.",
      "MongoDB를 활용한 데이터베이스 설계 및 초기 구축으로 효율적인 데이터 관리를 구현했습니다.",
      "ERD 설계를 통한 데이터베이스 모델링으로 복잡한 제품 및 주문 관리에 최적화된 데이터 구조를 설계했습니다.",
      "CRUD",
      "서버, REST API",
      "스켈레톤",
      "AWS",
  ...
  project_6: {
    id: 6,
    title: "Eco Vision",
    subTitle: "야생동물 모니터링 및 출몰 알림 서비스",
    type: "team",
    stack: [
      "Vue.js",
      "TypeScript",
    ...
    * 머신러닝을 통한 동물 종 식별까지를 목표로 구현했습니다.
    ...
    character: [
      "카카오지도 API를 활용하여 야생동물 출몰 위치를 지도에 표시하고 위험 반경을 시각화했습니다.",
      "Flask와 PyTorch를 연동하여 머신러닝 기능이 통합된 웹 서비스를 개발했습니다.",
  ...
  project_8: {
    ...
    character: [
      "Jungle 라이브러리를 활용해 실시간 오디오 신호 처리와 3도 화음 생성 기능을 구현했습니다.",
      "Tailwind CSS를 활용한 반응형 디자인으로 다양한 기기에서 최적화된 사용자 경험을 제공했습니다.",
      "m4a 파일 저장 기능을 제공하여 음원을 쉽게 다운로드 가능합니다.",
    ],
    troubleShooting: {
      trouble: "이슈",
      shooting: "해결방법",
  ...
  project_9: {
    ...
    character: [
      ...
      "실시간 오디오 처리를 위한 서버 통신 구현으로 지연 없는 음성 변조 기능을 구현했습니다.",
      "모바일 퍼스트",
    ],
    troubleShooting: {
      trouble: "이슈",
  ...
  project_10: {
    ...
    character: [
      ...
      "CRUD 기능을 구현하여 일정 추가, 조회, 수정, 삭제가 가능한 동적 웹 애플리케이션입니다.",

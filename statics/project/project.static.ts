export const projectStatics = {
  project_1: {
    ...
    function: [
      "🔍 짬뽕집 위치 검색: 검색 기능을 활용하여 사용자가 원하는 지역의 짬뽕집을 쉽게 찾을 수 있습니다.",
      "🗺 지도 기반 탐색: 카카오 지도 API를 활용하여 짬뽕집의 위치를 직관적으로 확인할 수 있습니다.",
  ...
  project_2: {
    ...
    exp: "세상에 존재하지 않는 자판기를 주제로 만든 mini ERP 프로젝트입니다. 사용자는 꿈 자판기에서 원하는 꿈을 구매하고, 관리자는 제품의 재고와 매출을 효율적으로 관리할 수 있는 웹 애플리케이션입니다.",
    function: [
  ...
  project_3: {
    ...
    function: [
      "🛒 사용자 페이지: 빵, 패티, 사이드, 음료를 직접 선택하여 맞춤형 햄버거 주문",
      "📦 재고 관리 페이지: 제품 정보 수정 및 제품 발주 기능",
      "⏳ 유통기한 관리 페이지: 유통기한이 지난 제품을 확인하고 목록에서 폐기",
      "💰 매출 관리 페이지: 일별, 월별 매출 데이터 확인 및 분석",
      "👥 회원 관리 페이지: 회원 정보 조회 및 권한 설정",
      "📊 인사이트 페이지: 최다 방문자, 평균 체류 시간, 최다 발주 제품, 폐기 메뉴, 인기 메뉴 통계 제공",
  ...
  project_4: {
    ...
    exp: "머신러닝 프로젝트로 진행한 야생동물 모니터링 및 출몰 알림 서비스입니다.",
    function: [
  ...
  project_7: {
    ...
    function: [
      "⏱️ 타이머: 게임이 시작되면 시간이 자동으로 카운트 됩니다. 주어진 시간 안에 문장을 입력해야합니다.",
